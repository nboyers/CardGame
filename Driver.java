//********************************************************************
//  Driver.java       Author: Noah Boyers
...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This program lets you play the  card game, HighLow.");
        ...
        String playAgain;       // Record user's response when user is
        try (//   asked whether he wants to play
                //   another game.
    ...
    private static int play() {
        ...
        while (true) {  // Loop ends when user's prediction is wrong.
            ...
            do {
                ...
                if (guess.charAt(0) != 'H' && guess.charAt(0) != 'L')
                    System.out.print("Please respond with H or L:  ");
            } while (guess.charAt(0) != 'H' && guess.charAt(0) != 'L');
